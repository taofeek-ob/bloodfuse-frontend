...
const Sidebar = ({closeModal}) => {
  ...
  >
    <Popover.Panel
      focus
      className="absolute top-0 right-0  w-[75%] transition overflow-hidden z-20  md:hidden"
    >
      <div className=" ">
            ...
            <div className="mt-2">
              <nav className="flex flex-col justify-between items-left">
                ...
                <div className="mt-2 py-5 border-t-2 border-solid">
                  <Link to="/aboutus" className="text-black px-5">
                ...
                <div className="mt-2 py-5 border-t-2 border-solid">
                  <button className="text-black px-5" onClick={closeModal}>
