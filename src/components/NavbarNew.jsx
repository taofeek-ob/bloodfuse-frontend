...
export default function NavBar() {
  return (
    <Popover className="relative bg-primarybg text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center  py-6 md:justify-start md:space-x-10">
          ...
          <Popover.Group as="nav" className="hidden md:flex space-x-10">
                ...
                <>
                  <Popover.Button
                    className={classNames(
                      ...
                      "group bg-transparent outline-none inline-flex items-center text-base font-medium hover:text-white-900"
                    )}
                  >
            ...
            <a
              href="#about"
              className="text-base font-medium text-white-500 hover:text-white-900"
            >
              About Us
            </a>
          </Popover.Group>
          <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
            <a
              href="#"
              className="whitespace-nowrap text-base font-medium text-white-500 hover:text-white-900"
            >
              Sign up
            </a>
            <a
