    ...
    return (
        <>
            <div className='w-full h-[40vh] md:h-[30vh] lg:h-[50vh] relative flex flex-col justify-center'>
                ...
                <img src={AboutWoman} alt="Lovely Woman" className='absolute bottom-0 left-0 w-full h-full object-center object-cover -z-10' />
                <h1 className='text-4xl md:text-5xl text-[#fcfcfc] ml-4 md:ml-8 lg:ml-24 z-10 font-bold'>About Us</h1>
            </div>
            <div className='flex flex-col gap-4 items-start max-w-3xl min-h-[40vh] mx-auto px-8 py-8 md:py-24 text-[14px] text-[#333333] md:text-base font-[300]'>
                <h1 className='font-[500] text-2xl md:text-3xl lg:text-4xl pb-4'>Serving To Save Lives!</h1>
                ...
                <h1 className='font-[500] mx-auto md:mx-0 text-2xl md:text-3xl lg:text-4xl pt-6 pb-4'>Our Partners</h1>
                <div className='flex flex-col md:flex-row gap-24 md:gap-16 py-8 md:justify-between w-full'>
                    ...
                    <div className='flex flex-col gap-8 items-center justify-center'>
                        ...
                        <p className='font-extrabold text-base sm:text-xl'>CODEUP DIAGNOSTICS</p>
                    </div>
                    <div className='flex flex-col gap-8 items-center justify-center'>
